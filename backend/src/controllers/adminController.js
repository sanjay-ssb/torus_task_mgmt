...
// View task-related reports
export const viewReports = (req, res) => {
  // Example report generation
  const reports = [
    { task: 'Task 1', status: 'Completed', completedAt: new Date() },
    { task: 'Task 2', status: 'In Progress', dueDate: new Date() }
  ];
